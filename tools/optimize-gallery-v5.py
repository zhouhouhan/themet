...
bpy.ops.wm.open_mainfile(filepath=str(ROOT/'assets/models/blender/gallery-v5.blend'))
...
bpy.ops.export_scene.gltf(filepath=str(ROOT/'assets/models/gallery-v5.glb'),export_format='GLB',export_apply=True,export_cameras=True,export_lights=False,export_extras=True)
